...
#define warp_shuffle_index_u32(warp_ctx, value, lane) subgroupShuffle(value, lane)
#define warp_shuffle_index_f32(warp_ctx, value, lane) subgroupShuffle(value, lane)
