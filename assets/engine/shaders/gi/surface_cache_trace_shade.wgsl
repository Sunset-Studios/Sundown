...
@group(1) @binding(15) var texture_pool_roughness: texture_2d_array<f32>;
@group(1) @binding(16) var texture_pool_metallic: texture_2d_array<f32>;
@group(1) @binding(17) var texture_pool_ao: texture_2d_array<f32>;
@group(1) @binding(18) var texture_pool_height: texture_2d_array<f32>;
@group(1) @binding(19) var texture_pool_specular: texture_2d_array<f32>;
@group(1) @binding(20) var texture_pool_emission: texture_2d_array<f32>;
...
fn cs(@builtin(global_invocation_id) gid: vec3<u32>) {
    ...
    var world_tangent = safe_normalize(transform_local_direction_from_instance(
        instance_transform,
        tangent_local
    ));
    var world_bitangent = safe_normalize(transform_local_direction_from_instance(
        instance_transform,
        bitangent_local
    ));
