  ...
  execute(args) {
    ...
    if (debug_view) {
      switch (debug_view) {
        ...
        case "gi-probe-atlas":
        case "gi-atlas":
          Renderer.get().set_debug_draw_type(DebugDrawType.GI_ProbeAtlas);
          break;
        ...
        case "bvh":
          ...
          break;
        case "bvh8":
          Renderer.get().set_debug_draw_type(DebugDrawType.BVH8);
          break;
        case "blas-bounds":
          Renderer.get().set_debug_draw_type(DebugDrawType.BLAS_Bounds);
          break;
        case "blas-bvh8":
          Renderer.get().set_debug_draw_type(DebugDrawType.BLAS_BVH8);
          break;
        default:
