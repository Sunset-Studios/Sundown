...
export class UI3DRenderProcessor extends SimulationLayer {
   ...
   *
   * The query covers both persistent `Element3D` instances and the reusable
   ...
   *
   * Persistent `Element3D` event processing compares each UI entity against the
  ...
  /**
   * Updates cursor state and dispatches legacy `Element3D` events.
   *
  ...
  /**
   * Emits high-level Element3D callbacks for cursor transitions and button state.
   *
