...
export class MeshBLAS {
  ...
  static get dirty_meshes() { return this.#dirty_meshes; }
  
  /** @returns {boolean} True if both main and scratch systems are initialized */
  static get is_ready() { return this.#initialized && this.#scratch_initialized; }
  
  /** @returns {number} Current scratch buffer capacity in triangles */
  static get scratch_capacity() { return this.#current_scratch_capacity; }
  ...
  static get morton_codes_buffer() { return this.#morton_codes_buffer; }
  
  /** @returns {Buffer} Temporary Morton codes for radix sort ping-pong */
  static get temp_morton_codes_buffer() { return this.#temp_morton_codes_buffer; }
  
  /** @returns {Buffer} Triangle indices sorted by Morton code */
  static get sorted_indices_buffer() { return this.#sorted_indices_buffer; }
  
  /** @returns {Buffer} Temporary indices for sort passes */
  static get temp_sorted_indices_buffer() { return this.#temp_sorted_indices_buffer; }
  ...
  static get onesweep_global_hist_buffer() { return this.#onesweep_global_hist_buffer; }
  
  /** @returns {Buffer} Per-pass histogram data for work distribution */
  static get onesweep_pass_hist_buffer() { return this.#onesweep_pass_hist_buffer; }
  
  /** @returns {Buffer} Tile boundary indices for workgroup coordination */
  static get onesweep_tile_indices_buffer() { return this.#onesweep_tile_indices_buffer; }
  ...
  static get parent_idx_buffer() { return this.#parent_indices_buffer; }
  
  /** @returns {Buffer} Global BVH4 nodes storage (final optimized format) */
  static get bvh4_nodes_buffer() { return this.#bvh4_nodes_buffer; }
  
  /** @returns {Buffer} Build iteration state and progress tracking */
  static get bvh4_build_state_buffer() { return this.#bvh4_build_state_buffer; }
  
  /** @returns {Buffer} Child-parent index pairs for BVH4 conversion */
  static get bvh4_index_pairs_buffer() { return this.#bvh4_index_pairs_buffer; }
  
  /** @returns {Buffer} Primitive indices for BVH4 leaf node assignment */
  static get bvh4_prim_indices_buffer() { return this.#bvh4_prim_indices_buffer; }
  
  /** @returns {Buffer} Debug watchdog counters to prevent infinite loops */
  static get bvh4_debug_watchdog_buffer() { return this.#bvh4_debug_watchdog_buffer; }
  ...
  static get bounds_size() { return this.#bvh2_blas_size; }
  
  /** @returns {Buffer} BLAS bvh4 size */
  static get bvh4_size() { return this.#bvh4_blas_size; }
